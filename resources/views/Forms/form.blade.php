      ...
      <![endif]-->
        ...
        <div class="page-wrapper">
          ...
          <div class="container-fluid">
            ...
            <a href="{{route("album.show")}}" type="button" class="btn btn-success">Album</a>
            </div>
                        ...
                        <form class="form-horizontal" method="POST" action="{{route("form.store")}}" enctype="multipart/form-data" >
                          @csrf                         
                            ...
                            <div class="form-group">
                              ...
                              <input name="description" type="description" class="form-control"  placeholder="Enter description">
                              @error("description")
                              <p class="text-danger">{{$message}}</p>
                            ...
                            <div class="form-group">
                              ...
                              <input name="cover_image" type="file" class="form-control-file"  placeholder="Cover photo">
                              @error("cover_image")
                              <p class="text-danger">{{$message}}</p>
