        ...
        <div class="scroll-sidebar">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link  {{$active=="album" ? "active":""}} "
                 
                  href="{{route("album.show")}}"
                  aria-expanded="false"
                  ><i class="mdi mdi-border-inside"></i
                  ><span class="hide-menu">Album</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{route("form.create")}}" class="sidebar-link {{$active=="form" ? "active":""}} "
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Form </span></a
                    >
                  </li>
                  {{-- <li class="sidebar-item">
                    <a href="" class="sidebar-link "
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Album Edit </span></a
                    >
                  </li> --}}
